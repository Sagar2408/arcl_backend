...
exports.createShareholdersMeeting = async (req, res) => {
  try {
    ...
    await logAudit({
      ...
      module: MODULE_NAME,
      recordId: meeting.id,
      newData: meeting.toJSON(),
      description: `Created shareholders meeting "${meeting.title || 'record'}"`
    });
...
exports.updateShareholdersMeeting = async (req, res) => {
  try {
    ...
    await logAudit({
      ...
      oldData,
      newData: meeting.toJSON(),
      description: `Updated shareholders meeting "${meeting.title || 'record'}"`
    });
